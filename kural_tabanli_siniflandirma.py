...
labels = ["0_18", "19_23", "24_30", "31_40", "41_" + str(df["AGE"].max())]
...
def customer_check(new_users):
    return  agg_df[agg_df["customers_level_based"] == new_users]


# 33 yaşında ANDROID kullanan bir Türk kadını hangi segmente aittir ve ortalama ne kadar gelir kazandırması beklenir?
customer_check("TUR_ANDROID_FEMALE_31_40")

# 35 yaşında IOS kullanan bir Fransız kadını hangi segmente ve ortalama ne kadar gelir kazandırması beklenir?
customer_check("FRA_IOS_FEMALE_31_40")
